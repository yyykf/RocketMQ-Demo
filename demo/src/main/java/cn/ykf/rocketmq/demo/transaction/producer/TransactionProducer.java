...
public class TransactionProducer {
    ...
    public static void main(String[] args) throws MQClientException {
        ...
        // 问：如果支付流程是：支付成功-扣减库存-通知物流中心发货，那么支付的本地事务成功，并且发送了扣减库存的消息
        ...
        // 答：RocketMQ 机制已经确保了如果consumer消费消息失败，只要没有提交消息确认，MQ 服务端将会自动重试，最终一定能保证consumer消费成功
        // 如果是同步调用未通过mq的话，可以使用tcc分布式事务相关框架
